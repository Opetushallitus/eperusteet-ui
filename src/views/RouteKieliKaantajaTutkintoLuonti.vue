...
import { MaaraysDtoTilaEnum, MaaraysDtoTyyppiEnum, PerusteprojektiLuontiDtoTyyppiEnum } from '@shared/api/eperusteet';
...
onMounted(async () => {
  await props.perusteprojektiStore.fetchPohjaKieliKaantajaTutkinnot();
});
