...
import { Perusteet, Kayttajat } from '@/api';
import { TutoriaaliStore } from '@shared/stores/tutoriaali';
import { PageTiedoteDto, TiedoteDto, PerusteHakuDto } from '@/tyypit';
...
export default class RouteTiedotteet extends Mixins(EpRoute, validationMixin) {
  ...
  public async vahvistaPoisto() {
    ...
    return await this.$bvModal.msgBoxConfirm((vahvistusSisalto as any), {
